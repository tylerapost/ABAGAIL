...
public class tic_tac_toe_ga {
    private static Instance[] instances = initializeInstances();
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 13);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 14, 824);

    private static DataSet set = new DataSet(train_set);

    private static int inputLayer = 9, hiddenLayer=5, outputLayer = 1;
    ...
    public static void main(String[] args) {
        ...
        int[] iterations = {1, 5, 10, 25, 50, 100, 250, 500, 1000, 1500};
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int q = 0; q < population.length; q++) {
                ...
                write_output_to_file("Optimization_Results", "tic-tac-toe_results_ga.csv", final_result, true);
    ...
    private static Instance[] initializeInstances() {
        ...
        double[][][] attributes = new double[824][][];

        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/main/tic-tac-toe_csv.csv")));
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                System.out.println(attributes[i][1][0] + " " + i);
