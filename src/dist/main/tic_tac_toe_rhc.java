...
import shared.SumOfSquaresError;
	...
	public class tic_tac_toe_rhc {
	    ...
	    public static void main(String[] args) {
	        ...
	        int[] iterations = {1, 5, 10, 25, 50, 100, 250, 500, 1000};
	        ...
	        for (int trainingIterations : iterations) {
	            ...
	            for (int i = 0; i < oa.length; i++) {
	                ...
	                write_output_to_file("Optimization_Results", "ttt_results_rhc.csv", final_result, true);
